...
const OptionExampleContext = createContext<OptionExampleContextType>({
    ...
    setOptionExample: async () => {},
});

export const useOptionExample = () => useContext(OptionExampleContext);

export const OptionExampleProvider = ({ children }: { children: ReactNode }) => {
    const [optionExample, setOptionExample] = usePersistedState<OptionExample>("optionExample", "option-1");
